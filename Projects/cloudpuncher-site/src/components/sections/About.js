...
export default function About() {
  return (
    <section className="mx-auto mt-8 w-full max-w-3xl px-4">
      <div className="rounded-2xl border border-neutral-800/70 overflow-hidden">

        <div
          className="relative h-40 w-full bg-cover bg-center"
          style={{ backgroundImage: "url('/glassbuilding_darkblue_nitesky.jpeg')" }}
        >
        ...
        <div className="bg-neutral-900/35 p-6">
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            <a href="/David_Cox_SOC_Analyst_CV.pdf" className="rounded-lg bg-indigo-600 px-4 py-2 text-xs font-medium text-white hover:bg-indigo-500">Download CV</a>
            <a href="https://github.com/siestakeydbc" target="_blank" rel="noopener noreferrer" className="rounded-lg border border-neutral-700/70 bg-neutral-900/30 px-4 py-2 text-xs text-neutral-100 hover:border-neutral-600/60 hover:bg-neutral-900/45">GitHub</a>
            <a href="https://linkedin.com/in/davidbrookscox" target="_blank" rel="noopener noreferrer" className="rounded-lg border border-neutral-700/70 bg-neutral-900/30 px-4 py-2 text-xs text-neutral-100 hover:border-neutral-600/60 hover:bg-neutral-900/45">LinkedIn</a>
            <a href="mailto:dc.pentester@protonmail.com" className="rounded-lg border border-neutral-700/70 bg-neutral-900/30 px-4 py-2 text-xs text-neutral-100 hover:border-neutral-600/60 hover:bg-neutral-900/45">dc.pentester@protonmail.com</a>
          </div>
        </div>
